                    ...
                    <div class="dashboard-sidebar">
                        <div class="profile-top">
                            <div class="profile-image">
                                <img src="{{asset('assets/frontend')}}/images/avtar.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="profile-detail">
                                <h5>{{Auth::guard('CustomerAuth')->user()->name}}</h5>
                                <h6>{{Auth::guard('CustomerAuth')->user()->email}}</h6>
                            </div>
                        </div>
                        <div class="faq-tab">
                            <ul class="nav nav-tabs" id="top-tab" role="tablist">
                                ...
                                <li class="nav-item"><a href="{{ route('frontend.user.customerlogout') }}" class="nav-link">Log Out</a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab-pane fade show active" id="info">
                            <div class="counter-section">
                                <div class="welcome-msg">
                                    <h4>Hello, {{Auth::guard('CustomerAuth')->user()->name}} !</h4>
                                                ...
                                                <table class="table cart-table order-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('assets/frontend')}}/images/pro3/1.jpg"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('assets/frontend')}}/images/pro3/2.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('assets/frontend')}}/images/pro3/27.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('assets/frontend')}}/images/pro3/28.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('assets/frontend')}}/images/pro3/33.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{asset('assets/frontend')}}/images/pro3/34.jpg"
                                                                        class="blur-up lazyloaded" alt="">
                                                                </a>
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="address-book-section">
                                                <div class="row g-4">
                                                    <div class="select-box active col-xl-4 col-md-6">
                                                        <div class="address-box">
                                                            <div class="bank-logo">
                                                                <img src="{{asset('assets/frontend')}}/images/bank-logo.png"
                                                                    class="bank-logo">
                                                    ...
                                                    <div class="select-box col-xl-4 col-md-6">
                                                        <div class="address-box">
                                                            <div class="bank-logo">
                                                                <img src="{{asset('assets/frontend')}}/images/bank-logo1.png"
                                                                    class="bank-logo">
                                                                <img src="{{asset('assets/frontend')}}/images/visa.png"
                                                                    class="network-logo">
                                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('frontend.user.customerlogout') }}" class="btn btn-solid btn-custom">yes</a>
                </div>
            </div>
        </div>
    </div>
