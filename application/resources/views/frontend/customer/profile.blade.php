                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo"><a href="index.html"><img src="{{asset('assets/frontend')}}/images/icon/logo.png"
                                ...
                                <div class="icon-nav">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="{{asset('assets/frontend')}}/images/icon/search.png" onclick="openSearch()"
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            ...
                                            <ul class="show-div shopping-cart">
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="me-3"
                                                                src="{{asset('assets/frontend')}}/images/fashion/product/1.jpg"
                                                ...
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="me-3"
                                                                src="{{asset('assets/frontend')}}/images/fashion/product/2.jpg"
                                                                alt="Generic placeholder image"></a>
                                                        <div class="media-body">
                                                            <a href="#">
                                                                <h4>item name</h4>
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="{{asset('assets/frontend')}}/images/icon/logo.png" alt=""></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li><a href="#"><img src="{{asset('assets/frontend')}}/images/icon/visa.png" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/frontend')}}/images/icon/mastercard.png" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/frontend')}}/images/icon/paypal.png" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/frontend')}}/images/icon/american-express.png" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/frontend')}}/images/icon/discover.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
