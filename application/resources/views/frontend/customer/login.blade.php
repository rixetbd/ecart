...
<head>
    ...
    <meta name="description"
        content="ECart admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords"
        content="admin template, ECart admin template, dashboard template, flat admin template, responsive admin template, web app">
    ...
    <title>ECart - Premium Admin Template</title>
...
<body>
    ...
    <div class="page-wrapper">
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="top-tabContent">
                                    <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                        ...
                                        <form class="form-horizontal auth-form" action="{{route('frontend.user.userlogin')}}" method="POST">
                                            @csrf
                                    ...
                                    <div class="tab-pane fade" id="top-contact" role="tabpanel"
                                        ...
                                        <form class="form-horizontal auth-form" action="{{route('frontend.user.userregister')}}" method="POST">
                                            @csrf
                                            <div class="form-group">
                ...
                <a href="{{route('frontend.index')}}" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>back</a>
            </div>
        </div>
    </div>
